...
const NonOperationalLegalizationsComponent = (props) => {
  const {
  ...
  return (
    <SafeAreaProvider>
      ...
      <View style={styles.NonOperationalLegalizationsScreen}>
        <View style={styles.NonOperationalLegalizationsContainer}>
          <ScrollView nestedScrollEnabled={true}>
            <View style={styles.paragraphSize}>
              ...
              />
              <Typography type={"h5"} text={"Autorizador"} />
              <DropDownPicker
                listMode="SCROLLVIEW"
                ...
                setItems={setItemsAuth}
              />
              <Typography type={"h5"} text={"Justificación"} />
                  <TextInput
...
export default NonOperationalLegalizationsComponent;
